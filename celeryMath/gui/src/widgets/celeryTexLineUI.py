...
class Ui_CeleryTexLine(object):
    def setupUi(self, CeleryTexLine):
        ...
        CeleryTexLine.setStyleSheet(u"QPushButton,\n"
"QDoubleSpinBox,\n"
"QLineEdit\n"
"{\n"
...
"}")
    ...
    def retranslateUi(self, CeleryTexLine):
        ...
        self.btn_copy.setWhatsThis(QCoreApplication.translate("CeleryTexLine", u"Copy", None))
